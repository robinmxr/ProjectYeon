      ...
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{ $product->category->category_type }}">
        ...
        <!-- Block2 -->
          <a href="{{ route('product.view',$product->slug) }}">
            ...
            @php $i--; @endphp
            @endforeach
							<a href="#productmodal{{ $product->id }}" data-toggle="modal" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View
							</a>
                            <div class="wrap-modal1 js-modal1 p-t-60 p-b-20" id="productmodal{{ $product->id }}">
